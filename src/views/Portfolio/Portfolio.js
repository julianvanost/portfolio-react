          ...
          <div className="row">
            ...
            <div className="col-md-9">
              ...
              <p>
                ...
                <a className="largerLinks" target="_blank" rel="noopener noreferrer" href="https://www.returnhrefworksolutions.com/julian-van-ost">
                  My Web Portfolio
                </a>
              </p>
              <p className="text-center">
                <br></br>
                <img className="logoCryp" src={require("./ci-logo.png")} alt="CrypIt Logo"></img>
                <br></br>
              ...
              <p className="text-center">
                <br></br>
                <img className="logoCryp" src={require("./AbutrackLogo.png")} alt="Ambutrack Logo"></img>
                <br></br>
                <a className="text center largerLinks" target="_blank" rel="noopener noreferrer" href="https://AmbuTrack.herokuapp.com/">
                  <br></br>
                  Project Two: AmbuTrack
                </a>
              </p>
              <p className="text-center">
                <br></br>
                <img className="logoCryp" src={require("./CartnerGolf.png")} alt="Cartner Golf Logo"></img>
                <br></br>
                <a className="text center largerLinks" target="_blank" rel="noopener noreferrer" href="https://cartner-golf.herokuapp.com/">
                  <br></br>
                  Project Three: Cartner Golf
                </a>
              </p>
            </div>
          </div>
